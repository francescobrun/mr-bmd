...
**Note**: MATLAB and Python code give slightly different (numerical) results. MR-BMD might require a few minutes on a modern multi-core machine for 512x512 images. An implementation of a coventional multi-material BMD is also included in the repository for comparison.
