...
**Note**: MATLAB and Python code give slightly different (numerical) results. MR-BMD might require a few minutes on a modern multi-core machine for 512x512 images.
